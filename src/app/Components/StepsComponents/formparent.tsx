                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 flex items-center">
                        <div className="relative group">
                          <button
                            type="button"
                            className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:z-10 hover:bg-gray-50 rounded-l-md transition-colors"
                          >
                            {formData.currency || "$"}
                          </button>
                      ...
                      <input
                        ...
                        className="w-full rounded-md border border-gray-200 pl-8 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-200 ml-8"
                      />
                    </div>
                  </div>
                </div>
