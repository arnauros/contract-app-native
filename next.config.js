        ...
        headers: [
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.stripe.com https://va.vercel-scripts.com; connect-src 'self' https://*.stripe.com https://*.googleapis.com https://*.firebase.googleapis.com https://*.firebaseio.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://*.cloudfunctions.net https://api.ipify.org https://va.vercel-scripts.com; frame-src 'self' https://*.stripe.com; img-src 'self' data: https: http: blob:; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net;",
          },
        ],
      },
      {
